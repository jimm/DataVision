...
protected HashMap<Section, Collection<DocBookCol>> sectionCols;
...
protected void doStart() {
    sectionCols = new HashMap<Section, Collection<DocBookCol>>();
...
protected void doOutputSection(Section sect) {
    Collection<DocBookCol> cols = calcSectionCols(sect);
    if (cols.isEmpty())
	return;
 ...
 */
protected Collection<DocBookCol> calcSectionCols(Section sect) {
    Collection<DocBookCol> cols = null;
    if ((cols = (Collection<DocBookCol>)sectionCols.get(sect)) != null)
	return cols;

    cols = new ArrayList<DocBookCol>();
    double x = 0;
